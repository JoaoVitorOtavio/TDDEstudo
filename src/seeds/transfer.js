...
exports.seed = (knex) => {
  return knex('transactions').del()
      ...
      .then(() => knex('accounts').del()
        .then(() => knex('users').del()
          .then(() => knex('users').insert([
            {
              id: 10000, name: 'User #1', mail: 'user1@mail.com', password: '$2a$10$1GOjmbpxFMtPDMMKZmMPR.tiJtf43xhtVUi8Tey/bSwoheQcJV05S'
            },
            {
              id: 10001, name: 'User #2', mail: 'user2@mail.com', password: '$2a$10$1GOjmbpxFMtPDMMKZmMPR.tiJtf43xhtVUi8Tey/bSwoheQcJV05S'
            },
          ])))))
    ...
    .then(() => knex('transactions').insert([
      ...
      { description: 'Transfer from AccD #1', date: new Date(), ammount: -100, type: 'O', acc_id: 10000, transfer_id: 10000 },
      { description: 'Transfer from AccO #2', date: new Date(), ammount: 100, type: 'I', acc_id: 10003, transfer_id: 10001 },
      { description: 'Transfer from AccD #2', date: new Date(), ammount: -100, type: 'O', acc_id: 10002, transfer_id: 10001 },
    ]))
};
